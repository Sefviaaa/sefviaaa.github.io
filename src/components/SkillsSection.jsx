...
const skills = [
  ...
  { name: "ETL/ELT Pipelines", level: 80, category: "data" },
  { name: "Data Warehousing", level: 75, category: "data" },
  { name: "C++", level: 70, category: "data" },

  // Machine Learning
  { name: "TensorFlow", level: 85, category: "ml" },
  { name: "Deep Learning", level: 85, category: "ml" },
  { name: "Biomedical Image Analysis", level: 80, category: "ml" },
  ...
  { name: "FastAPI", level: 75, category: "tools" },
  { name: "MATLAB", level: 70, category: "tools" },
  { name: "VS Code", level: 90, category: "tools" },
];

const categories = ["all", "data", "ml", "tools"];
